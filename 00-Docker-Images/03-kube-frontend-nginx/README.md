...
- **Important Note**: In the below listed commands wherever you see **thedevopsstore** you can replace with your docker hub account id. 
...
```
# Build Docker Image
docker build -t thedevopsstore/kube-frontend-nginx:1.0.0 .
...
docker push thedevopsstore/kube-frontend-nginx:1.0.0 
